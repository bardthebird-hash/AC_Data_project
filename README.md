...
This study is modeled after WEC/IMSA (Multiclass) racing, featuring two distinct vehicle tiers:
    ...
    Prototypes (LMP1): Highly technical, high-downforce, and hybrid-powered machines, like the Audi R18 or Porche 919.

    GT3: Slower, production-based vehicles that represent the bridge between road cars and pure race cars, like the Nissan GT-R GT3 or Ferrari 488 GT3.
